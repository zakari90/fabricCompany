    ...
    <section className='app'>
          <div key={product.id} className="details">
            <div className='large-img-wrapper'>
              <Image
              height={400}
              width={400} src={product.pictures[index]} alt="largeImg" className='large-img'/>
            </div>
            ...
            <div className='box'>
              ...
              <div className='py-4' ><WhatsAppLink productName={product.name} /></div>
            </div>
          </div>
    </section>
  );
